...
payments, settlements, reconciliation, Privy, Arc, or The Graph. Prefer tests at
...
| Graph delay or absence | The Graph temporarily returns nothing or lags | No duplicate settlement; absence is not non-payment proof |
