...
- [`coder-c/`](coder-c/README.md): Subgraph, Graph client, reconciliation, failure injection, recovery UI, qualification.
...
Never reinterpret `UNKNOWN`, monetary precision, settlement ownership, or Graph authority through a compatibility shortcut.
