...
describe('API runtime configuration', () => {
  ...
  it('does not require a server-side supplier recipient or quote amount', () => {
    expect(loadApiRuntimeConfig({ ...base })).toMatchObject({
  ...
  it('enables personal MCP credentials without a shared bearer', () => {
    const config = loadApiRuntimeConfig({
      ...base,
