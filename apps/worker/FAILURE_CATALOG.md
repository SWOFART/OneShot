...
| **FP-04: Definitive rejection** | Port returns `DEFINITELY_NOT_SUBMITTED` | `SUBMITTING` | 1 | Transition to `FAILED_SAFE`, persist failure reason | Terminal non-retryable state |
