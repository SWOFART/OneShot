...
| ------------------------------------------ | ------------------------------------------------------------------------------------------------ | --------------------------------------- | ------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| **FP-01: Crash before submission**         | Process killed before `claimSubmission` CAS or while the atomic claim transaction is uncommitted | `READY`                                 | 0                   | Safe continuation: worker picks up job and executes CAS with provider identity binding                         | Zero unintended side effects; retry allowed    |
